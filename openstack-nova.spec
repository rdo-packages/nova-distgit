...
Requires(pre): libvirt-daemon-driver-storage-disk >= %{libvirt_version}
Requires(pre): libvirt-daemon-driver-storage-rbd >= %{libvirt_version}
Requires(pre): libvirt-daemon-driver-storage-scsi >= %{libvirt_version}
%endif
%if 0%{?with_novanet}
