...
# The below versions map onto MIN_{LIBVIRT,QEMU}_VERSION for 'Stein'
# release.  This way, it also won't break RDO's Fedora builders:
%if 0%{?fedora}
%global qemu_version     2.8.0
%global libvirt_version  3.0.0
%endif
# For EL7 and EL8, use the minimum supported versions (which are
# also validated by QE):
%if 0%{?rhel} == 7
%global qemu_version     2.10.0
...
%if 0%{?rhel} == 7
Requires(pre): qemu-kvm-rhev >= %{qemu_version}
...
%changelog
* Mon Mar 15 2021 RDO <dev@lists.rdoproject.org> 1:20.6.0-1
- Update to 20.6.0

* Thu Feb 04 2021 RDO <dev@lists.rdoproject.org> 1:20.5.0-1
- Update to 20.5.0

* Mon Nov 09 2020 RDO <dev@lists.rdoproject.org> 1:20.4.1-1
- Update to 20.4.1

* Mon Aug 31 2020 Tobias Urdin <tobias.urdin@binero.com> 1:20.4.0-1
- Update to 20.4.0

* Mon Jun 15 2020 RDO <dev@lists.rdoproject.org> 1:20.3.0-1
- Update to 20.3.0

* Thu Apr 23 2020 RDO <dev@lists.rdoproject.org> 1:20.2.0-1
- Update to 20.2.0

* Mon Feb 10 2020 RDO <dev@lists.rdoproject.org> 1:20.1.1-1
- Update to 20.1.1

* Thu Feb 06 2020 RDO <dev@lists.rdoproject.org> 1:20.1.0-1
- Update to 20.1.0

* Tue Nov 12 2019 RDO <dev@lists.rdoproject.org> 1:20.0.1-1
- Update to 20.0.1

* Wed Oct 16 2019 RDO <dev@lists.rdoproject.org> 1:20.0.0-1
- Update to 20.0.0

* Fri Oct 11 2019 RDO <dev@lists.rdoproject.org> 1:20.0.0-0.2.0rc1
- Update to 20.0.0.0rc2

* Mon Sep 30 2019 RDO <dev@lists.rdoproject.org> 1:20.0.0-0.1.0rc1
