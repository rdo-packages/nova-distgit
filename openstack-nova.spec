...
install -p -D -m 400 %{SOURCE36} %{buildroot}%{_sharedstatedir}/nova/.ssh/config

# Install nova migration ssh wrapper command
install -p -D -m 400 %{SOURCE37} %{buildroot}%{_bindir}/nova-migration-wrapper
...
%attr(0400, nova, nova) %{_sharedstatedir}/nova/.ssh/config
