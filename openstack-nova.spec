...
%changelog
* Wed Jan 10 2018 RDO <dev@lists.rdoproject.org> 1:14.1.0-1
- Update to 14.1.0

* Thu Nov 16 2017 RDO <dev@lists.rdoproject.org> 1:14.0.10-1
- Update to 14.0.10

* Wed Nov 01 2017 RDO <dev@lists.rdoproject.org> 1:14.0.9-1
- Update to 14.0.9

* Mon Aug 28 2017 rdo-trunk <javier.pena@redhat.com> 1:14.0.8-1
- Update to 14.0.8

* Wed Aug 02 2017 Oliver Walsh <owalsh@redhat.com> 1:14.0.7-2
- Add explicit requirement on libvirt-client
- Whitelist all possible nova migration scp commands (rhbz#1476332 & rhbz#1472723)

* Tue May 30 2017 rdo-trunk <javier.pena@redhat.com> 1:14.0.7-1
- Update to 14.0.7

* Tue May 09 2017 rdo-trunk <javier.pena@redhat.com> 1:14.0.6-1
- Update to 14.0.6
