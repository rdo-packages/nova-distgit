...
%if 0%{?rhosp} == 1
Source42:         contrib/bin/clean-on-delete.py
%endif
...
%if 0%{?rhosp} == 1
# Install nova downstream-only nvme cleanup script
install -p -D -m 755 %{SOURCE42} %{buildroot}%{_bindir}/clean-on-delete
%endif
...
%changelog
* Thu Oct 24 2024 RDO <dev@lists.rdoproject.org> 1:27.5.1-1
- Update to 27.5.1

* Fri Aug 09 2024 RDO <dev@lists.rdoproject.org> 1:27.5.0-1
- Update to 27.5.0

* Tue Jul 09 2024 RDO <dev@lists.rdoproject.org> 1:27.4.0-1
- Update to 27.4.0

* Tue May 14 2024 RDO <dev@lists.rdoproject.org> 1:27.3.0-1
- Update to 27.3.0

* Thu Dec 14 2023 RDO <dev@lists.rdoproject.org> 1:27.2.0-1
- Update to 27.2.0

* Wed May 17 2023 RDO <dev@lists.rdoproject.org> 1:27.1.0-1
- Update to 27.1.0

* Fri Mar 31 2023 RDO <dev@lists.rdoproject.org> 1:27.0.0-1
- Update to 27.0.0

* Tue Mar 14 2023 RDO <dev@lists.rdoproject.org> 1:27.0.0-0.1.0rc1
- Update to 27.0.0.0rc1
