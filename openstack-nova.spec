...
%changelog
* Mon Oct 08 2018 RDO <dev@lists.rdoproject.org> 1:15.1.5-1
- Update to 15.1.5

* Wed Sep 26 2018 RDO <dev@lists.rdoproject.org> 1:15.1.4-1
- Update to 15.1.4

* Mon Jun 11 2018 RDO <dev@lists.rdoproject.org> 1:15.1.3-1
- Update to 15.1.3

* Tue May 15 2018 RDO <dev@lists.rdoproject.org> 1:15.1.2-1
- Update to 15.1.2

* Wed Jan 03 2018 RDO <dev@lists.rdoproject.org> 1:15.1.0-1
- Update to 15.1.0

* Wed Nov 15 2017 RDO <dev@lists.rdoproject.org> 1:15.0.8-1
- Update to 15.0.8
...
* Tue May 30 2017 rdo-trunk <javier.pena@redhat.com> 1:15.0.5-1
- Update to 15.0.5
...
* Wed Mar 22 2017 Alfredo Moralejo <amoralej@redhat.com> 1:15.0.2-1
- Update to 15.0.2

* Wed Mar 15 2017 Alfredo Moralejo <amoralej@redhat.com> 1:15.0.1-1
- Update to 15.0.1

* Wed Feb 22 2017 Alfredo Moralejo <amoralej@redhat.com> 1:15.0.0-1
- Update to 15.0.0
